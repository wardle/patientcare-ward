...
* [`src/clj/pc_ward/`](src/clj/pc_ward/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/pc_ward/`](src/cljs/pc_ward/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/pc_ward/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `pc-ward` project root directory
...
in the [`src/clj/pc_ward/`](src/clj/pc_ward/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/pc_ward/config.cljs) defaults to `true` in
...
```clj
(ns pc-ward.example
  (:require [pc-ward.config :as config])
